...
PYTHON_BIN="$PICO_PROJECT_DIR/.venv/bin/python"
...
echo "[install_xrobottoolkit_sdk] syncing isolated PICO environment"
uv sync --project "$PICO_PROJECT_DIR"
...
(cd "$SIM2REAL_ROOT" && "$PYTHON_BIN" - <<'PY'
